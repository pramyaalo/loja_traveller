class Table4CreditNoteHotelreceiptModel {
  ...
  Table4CreditNoteHotelreceiptModel({
  ...
  factory Table4CreditNoteHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table4CreditNoteHotelreceiptModel(
