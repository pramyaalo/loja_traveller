class Table3InvoiceHotelreceiptModel {
  ...
  Table3InvoiceHotelreceiptModel({
  ...
  factory Table3InvoiceHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table3InvoiceHotelreceiptModel(
