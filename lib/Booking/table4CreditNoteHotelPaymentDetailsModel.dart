class table4CreditNoteHotelPaymentDetailsModel {
  ...
  table4CreditNoteHotelPaymentDetailsModel({
  ...
  factory table4CreditNoteHotelPaymentDetailsModel.fromJson(Map<String, dynamic> json) {
    return table4CreditNoteHotelPaymentDetailsModel(
