...
import '../Booking/Table8CLientInvoiceBusRemittanceModel.dart';
...
import '../utils/response_handler.dart';
 import 'Table24CreditNoteBusTotalPriceModel.dart';
import 'Table2BusDetailModel.dart';
import 'Table3BusTravellerInformationModel.dart';
import 'Table4BusPaymentInformationModel.dart';
...
import 'Table7CreditNoteBusreceiptModel.dart';


class CreditNoteBusReceipt extends StatefulWidget {
  final String Id;

  CreditNoteBusReceipt({required this.Id});
  @override
  State<CreditNoteBusReceipt> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<CreditNoteBusReceipt> {
  ...
  List<Table3BusTravellerInformationModel>tabledata3=[];
  List<Table4BusPaymentInformationModel>tableData4=[];
                      ...
                      try {
                        ...
                        if (table4 != null && table4 is List && table4.isNotEmpty) {
                          for (int i = 0; i < table4.length; i++) {
                            Table4BusPaymentInformationModel t6Data =
                            Table4BusPaymentInformationModel.fromJson(table4[i]);
                        ...
                        Table24CreditNoteBusTotalPriceModel? m24;

                        if (table24.isNotEmpty) {
                          m24 = Table24CreditNoteBusTotalPriceModel.fromJson(table24[0]);
                          print("Inside if: ${m24.serviceTaxAmount}");
                        } else {
                          print('The list is empty.');
                        }

// ✅ Now you can safely check and use m24
                        if (m24 != null) {
                          print("Outside if: ${m24.totalFare}");
                        }
                        ...
                        if (table3 != null && table3 is List && table3.isNotEmpty) {
                          for (int i = 0; i < table3.length; i++) {
                            Table3BusTravellerInformationModel t3Data =
                            Table3BusTravellerInformationModel.fromJson(table3[i]);
                        ...
                        Table7CreditNoteBusreceiptModel m7 =
                        Table7CreditNoteBusreceiptModel.fromJson(table7[0]);
                        if (table7.isNotEmpty) {
                          m7 = Table7CreditNoteBusreceiptModel.fromJson(table7[0]);
                          print("fjhg" + m7.phone);
                        } else {
                          print('The list is empty.');
                        }
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(width: 10), // Adds space between text widgets
                                                Text(
