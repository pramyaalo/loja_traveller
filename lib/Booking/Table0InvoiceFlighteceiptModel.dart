class Table0InvoiceFlighteceiptModel {
  String bookFlightId;
  String bookingId;
  ...
  Table0InvoiceFlighteceiptModel({
  ...
  factory Table0InvoiceFlighteceiptModel.fromJson(Map<String, dynamic> json) {
    return Table0InvoiceFlighteceiptModel(
