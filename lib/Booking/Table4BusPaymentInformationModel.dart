class Table4BusPaymentInformationModel {
  ...
  Table4BusPaymentInformationModel({
  ...
  factory Table4BusPaymentInformationModel.fromJson(Map<String, dynamic> json) {
    return Table4BusPaymentInformationModel(
