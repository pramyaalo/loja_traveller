class Table27FlightReturnRoundWayModel {
  ...
  Table27FlightReturnRoundWayModel({
  ...
  factory Table27FlightReturnRoundWayModel.fromJson(Map<String, dynamic> json) {
    return Table27FlightReturnRoundWayModel(
