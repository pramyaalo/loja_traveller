class Table1InvoiceHotelReceiptModel {
  ...
  Table1InvoiceHotelReceiptModel({
  ...
  factory Table1InvoiceHotelReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table1InvoiceHotelReceiptModel(
