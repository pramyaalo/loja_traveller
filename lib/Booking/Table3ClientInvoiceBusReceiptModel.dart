class Table3ClientInvoiceBusReceiptModel {
  ...
  Table3ClientInvoiceBusReceiptModel({
  ...
  factory Table3ClientInvoiceBusReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table3ClientInvoiceBusReceiptModel(
