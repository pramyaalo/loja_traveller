...
class BusItinerary extends StatefulWidget {
  final String Id;

  BusItinerary({required this.Id});
  @override
  State<BusItinerary> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<BusItinerary> {
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "RecBusItinerary", "BookId=${widget.Id}");
