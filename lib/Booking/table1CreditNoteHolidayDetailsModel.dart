class table1CreditNoteHolidayDetailsModel {
  ...
  table1CreditNoteHolidayDetailsModel({
  ...
  factory table1CreditNoteHolidayDetailsModel.fromJson(Map<String, dynamic> json) {
    return table1CreditNoteHolidayDetailsModel(
