...
import 'Table8ClientInvoiceCarRemittanceModel.dart';
...
class _BookingCardGeneralDetailsState extends State<ClientInvoiceCarReceipt> {
  ...
  List<Table3ClientInvoiceCarReceiptModel>tabledata3=[];
  ...
  List<Table8ClientInvoiceCarRemittanceModel>tableData8=[];
...
// ✅ Now you can safely check and use m22
                        ...
                        if (table3 != null && table3 is List && table3.isNotEmpty) {
                          for (int i = 0; i < table3.length; i++) {
                            Table3ClientInvoiceCarReceiptModel t3Data =
                            Table3ClientInvoiceCarReceiptModel.fromJson(table3[i]);
                        ...
                        if (table8 != null && table8 is List && table8.isNotEmpty) {
                          for (int i = 0; i < table8.length; i++) {
                            Table8ClientInvoiceCarRemittanceModel t6Data =
                            Table8ClientInvoiceCarRemittanceModel.fromJson(table8[i]);
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Expanded(
                                                  child: Text(
                                                    'Passenger ID: ${tabledata3[index].pnr}',
                                                    style: TextStyle(
                                                      fontWeight: FontWeight.w500,
                                                      fontSize: 15,
                                                    ),
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: Text(
                                                          'Drop Off: ${tableData8[index].dropoffDate}',
                                                          style: (TextStyle(
                                                              fontWeight:
                                                              FontWeight.w500,
                                                              fontSize: 15))),
