...
import 'Table8CarReceiptModel.dart';


class CarReceipt extends StatefulWidget {
  final String Id;

  CarReceipt({required this.Id});
  @override
  State<CarReceipt> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<CarReceipt> {
  ...
  List<Table8CarReceiptModel>tableData8=[];
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "RecCarReceipt", "BookId=${widget.Id}");
                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  try {
                    ...
                    if (table8.isNotEmpty) {
                      Table8CarReceiptModel m12 = Table8CarReceiptModel.fromJson(table8[0]);

                      for (int i = 0; i < table8.length; i++) {
                        Table8CarReceiptModel t6Data = Table8CarReceiptModel.fromJson(table8[i]);
                        tableData8.add(t6Data);
                        print('Index: $i, Table4 Length: ${table12.length}, t1Data: $t6Data');
                      }
                    } else {
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                        'Base Fare: ${tableData5[index].currency1} ${tableData5[index].totalSales}',
                                                        style: (TextStyle(
                                                            fontWeight:
                                                            FontWeight.w500,
                                                            fontSize: 15))),
                                                    Text(
                                                        'Total: ${tableData5[index].currency1} ${tableData5[index].totalNett}',
                                                        style: (TextStyle(
                                                            fontWeight:
                                                            FontWeight.w500,
                                                            fontSize: 15))),
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Receipt No: ${tableData8[index].receiptNo}',
                                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Allocated Amount: ${tableData8[index].allocatedAmount}',
                                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                'Status: ${tableData8[index].status}',
                                                style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                              ),
                                              Text(
                                                'Date: ${tableData8[index].createdDatedt}',
                                                style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                              ),
                                            ],
                                          ),
