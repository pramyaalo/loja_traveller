class Table2VouchersCarreceiptModel {
  final String tCarID;
  ...
  factory Table2VouchersCarreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table2VouchersCarreceiptModel(
