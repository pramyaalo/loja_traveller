class Table6HotelReceiptTermsandConditionModel {
  ...
  Table6HotelReceiptTermsandConditionModel({
  ...
  factory Table6HotelReceiptTermsandConditionModel.fromJson(Map<String, dynamic> json) {
    return Table6HotelReceiptTermsandConditionModel(
