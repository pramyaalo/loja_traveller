class Table13CarDescriptionModel {
  final String tCarID;
  ...
  factory Table13CarDescriptionModel.fromJson(Map<String, dynamic> json) {
    return Table13CarDescriptionModel(
