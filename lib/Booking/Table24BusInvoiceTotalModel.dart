class Table24BusInvoiceTotalModel {
  ...
  factory Table24BusInvoiceTotalModel.fromJson(Map<String, dynamic> json) {
    return Table24BusInvoiceTotalModel(
