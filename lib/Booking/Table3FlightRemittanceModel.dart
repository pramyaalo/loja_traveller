class Table3FlightRemittanceModel {
  ...
  factory Table3FlightRemittanceModel.fromJson(Map<String, dynamic> json) {
    return Table3FlightRemittanceModel(
