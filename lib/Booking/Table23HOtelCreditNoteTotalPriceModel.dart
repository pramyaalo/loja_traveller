class Table23HOtelCreditNoteTotalPriceModel {
  ...
  Table23HOtelCreditNoteTotalPriceModel({
  ...
  factory Table23HOtelCreditNoteTotalPriceModel.fromJson(Map<String, dynamic> json) {
    return Table23HOtelCreditNoteTotalPriceModel(
