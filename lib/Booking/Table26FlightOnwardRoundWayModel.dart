class Table26FlightOnwardRoundWayModel {
  ...
  Table26FlightOnwardRoundWayModel({
  ...
  factory Table26FlightOnwardRoundWayModel.fromJson(Map<String, dynamic> json) {
    return Table26FlightOnwardRoundWayModel(
