class Table23CLientInvoiceHotelreceiptModel {
  ...
  Table23CLientInvoiceHotelreceiptModel({
  ...
  factory Table23CLientInvoiceHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table23CLientInvoiceHotelreceiptModel(
