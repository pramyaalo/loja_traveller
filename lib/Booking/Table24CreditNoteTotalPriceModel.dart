class Table24CreditNoteTotalPriceModel {
  ...
  Table24CreditNoteTotalPriceModel({
  ...
  factory Table24CreditNoteTotalPriceModel.fromJson(Map<String, dynamic> json) {
    return Table24CreditNoteTotalPriceModel(
