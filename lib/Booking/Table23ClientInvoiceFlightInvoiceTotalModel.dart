class Table23ClientInvoiceFlightInvoiceTotalModel {
  ...
  Table23ClientInvoiceFlightInvoiceTotalModel({
  ...
  factory Table23ClientInvoiceFlightInvoiceTotalModel.fromJson(Map<String, dynamic> json) {
    return Table23ClientInvoiceFlightInvoiceTotalModel(
