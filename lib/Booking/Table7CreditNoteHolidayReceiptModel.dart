class Table7CreditNoteHolidayReceiptModel {
  ...
  Table7CreditNoteHolidayReceiptModel({
  ...
  factory Table7CreditNoteHolidayReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table7CreditNoteHolidayReceiptModel(
