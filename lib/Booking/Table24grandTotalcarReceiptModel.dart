class Table24grandTotalcarReceiptModel {
  ...
  Table24grandTotalcarReceiptModel({
  ...
  factory Table24grandTotalcarReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table24grandTotalcarReceiptModel(
