class Table4CarPaymentInformationModel {
  ...
  Table4CarPaymentInformationModel({
  ...
  factory Table4CarPaymentInformationModel.fromJson(Map<String, dynamic> json) {
    return Table4CarPaymentInformationModel(
