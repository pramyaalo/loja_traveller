class Table47HotelAgentHolidayDetailsModel {
  ...
  factory Table47HotelAgentHolidayDetailsModel.fromJson(Map<String, dynamic> json) {
    return Table47HotelAgentHolidayDetailsModel(
