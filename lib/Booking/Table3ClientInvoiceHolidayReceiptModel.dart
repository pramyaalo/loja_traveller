class Table3ClientInvoiceHolidayReceiptModel {
  ...
  Table3ClientInvoiceHolidayReceiptModel({
  ...
  factory Table3ClientInvoiceHolidayReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table3ClientInvoiceHolidayReceiptModel(
