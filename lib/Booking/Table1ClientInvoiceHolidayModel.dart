class Table1ClientInvoiceHolidayModel {
  ...
  Table1ClientInvoiceHolidayModel({
  ...
  factory Table1ClientInvoiceHolidayModel.fromJson(Map<String, dynamic> json) {
    return Table1ClientInvoiceHolidayModel(
