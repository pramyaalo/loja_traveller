...
class HotelInvoice extends StatefulWidget {
  final String Id;

  HotelInvoice({required this.Id});
  @override
  State<HotelInvoice> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<HotelInvoice> {
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "RecHotelInvoice", "BookId=${widget.Id}");
                                                ...
                                                children: [
                                                  ...
                                                  Flexible(
                                                    child: Text(
                                                      ...
                                                      maxLines: 2, // Optional: allow wrapping to second line
                                                    ),
                                                  ),
                                                ],
                                              ),
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Tax: ${tableData5[0].currency1} ${tableData5[0].inputTax}',
                                                      style: (TextStyle(
                                                          fontWeight:
                                                          FontWeight.w500,
                                                          fontSize: 15)),
                                                    ...
                                                    Text(
                                                        'Other Charges: ${tableData5[0].currency1} ${tableData5[0].outputTax}',
                                                        style: (TextStyle(
                                                            fontWeight:
                                                            FontWeight.w500,
                                                            fontSize: 15))),
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                        'Base Fare:${tableData5[0].currency1} ${tableData5[0].totalSales}',
                                                        style: (TextStyle(
                                                            fontWeight:
                                                            FontWeight.w500,
                                                            fontSize: 15))),
                                                    Text(
                                                        'Total: ${tableData5[0].currency1} ${tableData5[0].totalNett}',
                                                        style: (TextStyle(
                                                            fontWeight:
                                                            FontWeight.w500,
                                                            fontSize: 15))),
