class Table3BusTravellerInformationModel {
  ...
  Table3BusTravellerInformationModel({
  ...
  factory Table3BusTravellerInformationModel.fromJson(Map<String, dynamic> json) {
    return Table3BusTravellerInformationModel(
