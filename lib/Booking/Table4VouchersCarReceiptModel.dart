class Table4VouchersCarReceiptModel {
  ...
  factory Table4VouchersCarReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table4VouchersCarReceiptModel(
