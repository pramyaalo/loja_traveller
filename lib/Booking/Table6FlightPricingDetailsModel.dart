class Table6FlightPricingDetailsModel {
  ...
  Table6FlightPricingDetailsModel({
  ...
  factory Table6FlightPricingDetailsModel.fromJson(Map<String, dynamic> json) {
    return Table6FlightPricingDetailsModel(
