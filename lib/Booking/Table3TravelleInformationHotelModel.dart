class Table3TravelleInformationHotelModel {
  ...
  Table3TravelleInformationHotelModel({
  ...
  factory Table3TravelleInformationHotelModel.fromJson(Map<String, dynamic> json) {
    return Table3TravelleInformationHotelModel(
