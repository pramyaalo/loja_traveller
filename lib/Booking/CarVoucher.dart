...
class CarVoucher extends StatefulWidget {
  ...
  CarVoucher({required this.Id});
  @override
  State<CarVoucher> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<CarVoucher> {
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  try {
                    ...
                    tableData11.clear();
                    Table11CarInvoiceTotalModel m11 =
                    Table11CarInvoiceTotalModel.fromJson(
                        table11[0]);
                    if (table11.isNotEmpty) {
                      for (int i = 0; i < table11.length; i++) {
                        Table11CarInvoiceTotalModel t1Data =
                        Table11CarInvoiceTotalModel.fromJson(
                            table11[i]);
                    ...
                    tableData13.clear();
                    Table13CarRemittenceModel m12 =
                    Table13CarRemittenceModel.fromJson(table13[0]);
                    if (table13.isNotEmpty) {
                      for (int i = 0; i < table13.length; i++) {
                        Table13CarRemittenceModel t6Data =
                        Table13CarRemittenceModel.fromJson(
                            table13[i]);
                            ...
                            Column(
                              children: [
                                      ...
                                      tableData3.length,
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                'Car Company: ${tableData3[index].carGroup}',
                                                style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                                                overflow: TextOverflow.ellipsis, // or fade, clip, etc.
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Text(
                                                        'Car Type: ${tableData3[index].cartype}',
                                                        style: (TextStyle(
                                                            fontWeight:
                                                            FontWeight.w500,
                                                            fontSize: 15))),
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                      'Pickup Location: ${tableData3[index].pickupLocation}',
                                                      style: (TextStyle(
                                                          fontWeight:
                                                          FontWeight.w500,
                                                          fontSize: 15))),
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                      'DropOff Location: ${tableData3[index].dropoffLocation}',
                                                      style: (TextStyle(
                                                          fontWeight:
                                                          FontWeight.w500,
                                                          fontSize: 15))),
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                      'Pickup Date: ${tableData3[index].pickupDtt}',
                                                      style: (TextStyle(
                                                          fontWeight:
                                                          FontWeight.w500,
                                                          fontSize: 15))),
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                      'DropOff Date: ${tableData3[index].dropoffDtt}',
                                                      style: (TextStyle(
                                                          fontWeight:
                                                          FontWeight.w500,
                                                          fontSize: 15))),
                                ...
                                Table(
                                  ...
                                  children: [
                                    _buildTableRow('Total Net Amount',m11.Currency, m11.totalFare),
                                    _buildTableRow(
                                    ...
                                    _buildTableRow('Total Price',m11.Currency, m11.grandTotal, isBold: true),
                                  ],
                                ),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      bulletPoint("This eTicket (a printout of the eTicket on plain paper) has to be carried by the passenger during the journey along with a valid photo identity card of at least one of the passengers of the group issued by one the government authority (Driving license, student id card, company id card, passport, PAN card, voter id card or credit card with photo etc.)."),

                                      SizedBox(height: 10),

                                      bulletPoint("Please keep the eTicket safely till the end of the journey."),

                                      SizedBox(height: 10),

                                      bulletPoint("Please show the eTicket at the time of checking."),

                                      SizedBox(height: 10),

                                      bulletPoint("The seat(s) booked under this eTicket is/are not transferable."),

                                      SizedBox(height: 10),

                                      bulletPoint("Passengers shall report at the boarding point at least 20 minutes prior to the scheduled departure."),
                                    ],
                                  ),
                                ),
                                SizedBox(
