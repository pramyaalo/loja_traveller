class Table1invoicelistHotelModel {
  ...
  factory Table1invoicelistHotelModel.fromJson(Map<String, dynamic> json) {
    return Table1invoicelistHotelModel(
