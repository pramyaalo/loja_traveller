...
class HotelInvoiceQuotationScreen extends StatefulWidget {
  final String Id;

  HotelInvoiceQuotationScreen({required this.Id});
  @override
  State<HotelInvoiceQuotationScreen> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<HotelInvoiceQuotationScreen> {
  ...
  List<Table6HotemModel>tableData6=[];
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "RecHotelQuotation", "BookId=${widget.Id}");
                  ...
                  try {
                    ...
                    if (table1.isNotEmpty) {
                      for (int i = 0; i < table1.length; i++) {
                        ...
                        print(
                            'Index: $i, Table4uiuti Length: ${table3
                    ...
                    if (table2.isNotEmpty) {
                      for (int i = 0; i < table2.length; i++) {
                        ...
                        print(
                            'Index: $i, Tabdghytle4 Length: ${table2
                                .length}, t1Data: $t1Data');
                      }
                    }
                    //tableData2
                    ...
                    if (table3.isNotEmpty) {
                      for (int i = 0; i < table3.length; i++) {
                        ...
                        print(
                            'Index: $i, Tadfgfdgble4 Length: ${table3
                                .length}, t1Data: $t1Data');
                      }
                    }
                    tableData4.clear();
                    ...
                    if (table4.isNotEmpty) {
                      for (int i = 0; i < table4.length; i++) {
                        ...
                        print(
                            'Index: $i, Tablsdde4 Length: ${table4
                                .length}, t1Data: $t1Data');
                      }
                    }
                    //
...
// table6
                    tableData6.clear();
                    Table6HotemModel m6 =
                    Table6HotemModel.fromJson(
                        table6[0]);
                    if (table6.isNotEmpty) {
                      for (int i = 0; i < table6.length; i++) {
                        Table6HotemModel t1Data =
                        Table6HotemModel.fromJson(
                            table6[i]);
                        tableData6.add(t1Data);
                        print(
                            'Index: $i, fsdfssfd ${table6.length}, t1Data: $t1Data');
                      }
                    }
...
// table12
                    ...
                    if (table12.isNotEmpty) {
                      m12 = Table12HotelRemitanceModel.fromJson(table12[0]);
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                      '${tableData6[index].cancellationPolicy}',
                                                      style: TextStyle(
                                                          fontSize: 15,
                                                          fontWeight:
                                                          FontWeight.w500)),
