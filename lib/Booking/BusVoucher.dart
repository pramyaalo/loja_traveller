...
import 'Table8BusReceiptModel.dart';


class BusVoucher extends StatefulWidget {
  final String Id;

  BusVoucher({required this.Id});
  @override
  State<BusVoucher> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<BusVoucher> {
  ...
  List<Table8BusReceiptModel>tableData8=[];
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "RecBusVoucher", "BookId=${widget.Id}");
                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  try {
                    ...
                    if (table8.isNotEmpty) {
                      Table8BusReceiptModel m12 = Table8BusReceiptModel.fromJson(table8[0]);

                      for (int i = 0; i < table8.length; i++) {
                        Table8BusReceiptModel t6Data = Table8BusReceiptModel.fromJson(table8[i]);
