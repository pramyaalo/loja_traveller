class Table15FlightReturnSegmentModel {
  String bftfSlightID;
  String tfsSeg;
  String tfsAirline;
  String tfsFlight;
  ...
  Table15FlightReturnSegmentModel({
  ...
  factory Table15FlightReturnSegmentModel.fromJson(Map<String, dynamic> json) {
    return Table15FlightReturnSegmentModel(
