...
import 'Table11FlightRefundModel.dart';
...
import 'Table5InvoiceFlightlistDub.dart';

class FlightrefundReceipt extends StatefulWidget {
  final String Id;

  FlightrefundReceipt({required this.Id});

  @override
  State<FlightrefundReceipt> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<FlightrefundReceipt> {
  ...
  List<Table11FlightRefundModel>tabledata11=[];
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "RecFlightRefund", "BookId=${widget.Id}");
                  ...
                  try {
                    ...
                    if (table1.isNotEmpty) {
                      for (int i = 0; i < table1.length; i++) {
                        ...
                        print(
                            'Index: $i, TablDsade4 Length: ${table1.length}, t1Data: $t1Data');
                      }
                    }
                    tableData14.clear();
                    ...
                    if (table11.isNotEmpty) {
                      Table11FlightRefundModel m10 = Table11FlightRefundModel.fromJson(table11[0]);

                      for (int i = 0; i < table11.length; i++) {
                        Table11FlightRefundModel t1Data =
                        Table11FlightRefundModel.fromJson(table11[i]);
                        tabledata11.add(t1Data);
                        print('Index: $i, Table10 Length: ${table11.length}, t1Data: $t1Data');
                      }
                    } else {
                    ...
                    if (table16.isNotEmpty) {
                      for (int i = 0; i < table16.length; i++) {
                        ...
                        print(
                            'Index: $i, TabsdsdlSDASDe4 Length: ${table6.length}, t1Data: $t6Data');
                      }
                    }
                    tableData2.clear();
                    ...
                    if (table2.isNotEmpty) {
                      for (int i = 0; i < table2.length; i++) {
                        ...
                        print(
                            'Index: $i, Table4dfs Length: ${table2.length}, t1Data: $t1Data');
                      }
                    }

                    tableData13.clear();
                    Table13FlightInvoiceModel m24 =
                    ...
                    if (table13.isNotEmpty) {
                      for (int i = 0; i < table13.length; i++) {
                        ...
                        print(
                            'Index: $i, TabSDsle4 Length: ${table6.length}, t1Data: $t6Data');
                      }
                    }

                    Table5InvoiceFlightlistDub m5 =
                    Table5InvoiceFlightlistDub.fromJson(table5[0]);
                    if (table5.isNotEmpty) {
                      m5 = Table5InvoiceFlightlistDub.fromJson(
                          table5[0]);
                      print("fjhg" + m5.phone);
                    } else {
                      print('The list is empty.');
                            ...
                            Column(
                              children: [
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  'Tax: $Currency ${tableData13[index].inputTax}',
                                                  style: (TextStyle(
                                                      fontWeight:
                                                      FontWeight.w500,
                                                      fontSize: 15)),
                                                ...
                                                Text(
                                                    'Other Charges: $Currency ${tableData13[index].outputTax}',
                                                    style: (TextStyle(
                                                        fontWeight:
                                                        FontWeight.w500,
                                                        fontSize: 15))),
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                    'Base Fare: $Currency ${tableData13[index].totalSales}',
                                                    style: (TextStyle(
                                                        fontWeight:
                                                        FontWeight.w500,
                                                        fontSize: 15))),
                                                Text(
                                                    'Total: $Currency ${tableData13[index].totalNett}',
                                                    style: (TextStyle(
                                                        fontWeight:
                                                        FontWeight.w500,
                                                        fontSize: 15))),
                                ...
                                Table(
                                  ...
                                  children: [
                                    _buildTableRow('Total Net Amount', m16.Currency,
                                        m16.totalFare),
                                    _buildTableRow(
                                    ...
                                    _buildTableRow('Total Discount', m16.Currency,
                                        m16.discountAmount),
                                    _buildTableRow(
                                        'Total Price', m16.Currency, m16.grandTotal,
                                        isBold: true),
                                  ],
                                ),
                                Padding(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Text(
                                                  'Refund Amount: ${tabledata11[index].refundAmount}',
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Text(
                                                  'Service Amount: ${tabledata11[index].refundServiceAmount}',
                                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                                                ),
                                              ],
                                            ),
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Text(
                                                  'Status: ${tabledata11[index].refundStatus}',
                                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                                                ),
                                              ],
                                            ),
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Text(
                                                  'Date: ${tabledata11[index].createdDatedt}',
