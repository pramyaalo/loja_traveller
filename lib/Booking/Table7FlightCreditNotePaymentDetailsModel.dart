class Table7FlightCreditNotePaymentDetailsModel {
  ...
  Table7FlightCreditNotePaymentDetailsModel({
  ...
  factory Table7FlightCreditNotePaymentDetailsModel.fromJson(Map<String, dynamic> json) {
    return Table7FlightCreditNotePaymentDetailsModel(
