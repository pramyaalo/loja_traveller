class Table3CreditNoteHotelreceiptModel {
  ...
  Table3CreditNoteHotelreceiptModel({
  ...
  factory Table3CreditNoteHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table3CreditNoteHotelreceiptModel(
