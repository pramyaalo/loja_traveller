...
import 'Table18FlightInvoiceModel.dart';
import 'Table13FlightInvoiceModel.dart';
import 'Table5InvoiceFlightlistDub.dart';

class FlightInvoice extends StatefulWidget {
  final String Id;

  FlightInvoice({required this.Id});

  @override
  State<FlightInvoice> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<FlightInvoice> {
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels =
        ResponseHandler.performPost("RecFlightInvoice", "BookId=${widget.Id}");
                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  try {
                    ...
                    if (table5.isNotEmpty) {
                      m5 = Table5InvoiceFlightlistDub.fromJson(table5[0]);
                      print("fjhg" + m5.phone);
                    } else {
                      print('The list is empty.');
                    }
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                                'Lead Passenger: ${tableData18[0].passenger}',
                                                style: TextStyle(
                                                    fontSize: 15,
                                                    fontWeight:
                                                        FontWeight.w500)),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              'Booking Ref: ${tableData18[0].bookingId}',
                                              style: (TextStyle(
                                                  fontWeight: FontWeight.w500,
                                                  fontSize: 15)),
                                            ),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                                'Date: ${tableData18[0].tfsDepDate}',
                                                style: (TextStyle(
                                                    fontWeight: FontWeight.w500,
                                                    fontSize: 15))),
                                            Text(
                                                'Total: ${tableData18[0].grandTotal}',
                                                style: (TextStyle(
                                                    fontWeight: FontWeight.w500,
                                                    fontSize: 15))),
                                          ],
