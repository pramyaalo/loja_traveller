class Table3HotelPassengerNameModel {
  ...
  factory Table3HotelPassengerNameModel.fromJson(Map<String, dynamic> json) {
    return Table3HotelPassengerNameModel(
