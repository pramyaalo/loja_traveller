class Table14FlightOnwardSegmentModel {
  String bftfSlightID;
  String tfsSeg;
  String tfsAirline;
  String tfsFlight;
  ...
  Table14FlightOnwardSegmentModel({
  ...
  factory Table14FlightOnwardSegmentModel.fromJson(Map<String, dynamic> json) {
    return Table14FlightOnwardSegmentModel(
