class Table22TermsnadCondfitionHolidayModel {
  ...
  Table22TermsnadCondfitionHolidayModel({
  ...
  factory Table22TermsnadCondfitionHolidayModel.fromJson(Map<String, dynamic> json) {
    return Table22TermsnadCondfitionHolidayModel(
