class Table3HolidayPassengerDetailsModel {
  ...
  Table3HolidayPassengerDetailsModel({
  ...
  factory Table3HolidayPassengerDetailsModel.fromJson(Map<String, dynamic> json) {
    return Table3HolidayPassengerDetailsModel(
