class Table4InvoiceholidayReceiptModel {
  ...
  factory Table4InvoiceholidayReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table4InvoiceholidayReceiptModel(
