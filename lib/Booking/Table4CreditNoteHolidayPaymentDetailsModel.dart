class Table4CreditNoteHolidayPaymentDetailsModel {
  ...
  Table4CreditNoteHolidayPaymentDetailsModel({
  ...
  factory Table4CreditNoteHolidayPaymentDetailsModel.fromJson(Map<String, dynamic> json) {
    return Table4CreditNoteHolidayPaymentDetailsModel(
