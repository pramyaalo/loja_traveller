class Table1HotelInformationModel {
  ...
  factory Table1HotelInformationModel.fromJson(Map<String, dynamic> json) {
    return Table1HotelInformationModel(
