class Table23CreditNoteHolidayTotalPriceModel {
  ...
  Table23CreditNoteHolidayTotalPriceModel({
  ...
  factory Table23CreditNoteHolidayTotalPriceModel.fromJson(Map<String, dynamic> json) {
    return Table23CreditNoteHolidayTotalPriceModel(
