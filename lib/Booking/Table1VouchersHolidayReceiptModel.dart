class Table1VouchersHolidayReceiptModel {
  ...
  Table1VouchersHolidayReceiptModel({
  ...
  // Factory method to create a HotelBooking object from JSON
  factory Table1VouchersHolidayReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table1VouchersHolidayReceiptModel(
  ...
  // Method to convert a HotelBooking object to JSON
