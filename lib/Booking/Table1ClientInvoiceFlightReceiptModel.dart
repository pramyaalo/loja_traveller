class Table1ClientInvoiceFlightReceiptModel {
  String bftfsLightID;
  String tfsSeg;
  String tfsAirline;
  String tfsFlight;
  ...
  Table1ClientInvoiceFlightReceiptModel({
  ...
  factory Table1ClientInvoiceFlightReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table1ClientInvoiceFlightReceiptModel(
