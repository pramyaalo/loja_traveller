  class Table42HotelTermsandConditionModel {
    ...
    Table42HotelTermsandConditionModel({
    ...
    factory Table42HotelTermsandConditionModel.fromJson(Map<String, dynamic> json) {
      return Table42HotelTermsandConditionModel(
