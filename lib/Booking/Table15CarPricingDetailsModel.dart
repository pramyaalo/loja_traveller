class Table15CarPricingDetailsModel {
  ...
  factory Table15CarPricingDetailsModel.fromJson(Map<String, dynamic> json) {
    return Table15CarPricingDetailsModel(
