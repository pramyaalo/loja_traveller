class Table3CreditNoteFlightPaymentDetailModel {
  ...
  Table3CreditNoteFlightPaymentDetailModel({
  ...
  factory Table3CreditNoteFlightPaymentDetailModel.fromJson(Map<String, dynamic> json) {
    return Table3CreditNoteFlightPaymentDetailModel(
