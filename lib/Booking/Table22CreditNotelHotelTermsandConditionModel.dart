class Table22CreditNotelHotelTermsandConditionModel {
  ...
  Table22CreditNotelHotelTermsandConditionModel({
  ...
  factory Table22CreditNotelHotelTermsandConditionModel.fromJson(Map<String, dynamic> json) {
    return Table22CreditNotelHotelTermsandConditionModel(
