class Table23FlightInvoiceTotalModel {
  ...
  Table23FlightInvoiceTotalModel({
  ...
  factory Table23FlightInvoiceTotalModel.fromJson(Map<String, dynamic> json) {
    return Table23FlightInvoiceTotalModel(
