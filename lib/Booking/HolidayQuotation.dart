...
class HolidayQuotation extends StatefulWidget {
  final String Id;

  HolidayQuotation({required this.Id});
  @override
  State<HolidayQuotation> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<HolidayQuotation> {
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "RecHolidayQuotation", "BookId=${widget.Id}");
