...
import 'ViiewMarkupcarFareModel.dart';

 


class ViewmarkupcarFare extends StatefulWidget {
  final String Id;

  ViewmarkupcarFare({required this.Id});

  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<ViewmarkupcarFare> {
  Future<List<ViiewMarkupcarFareModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ViiewMarkupcarFareModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupCarFareViewEdit", "Id=${widget.Id}");
    ...
    return await __futureLabels?.then((value) async {
      ...
      try {
        ...
        for (int i = 0; i < list.length; i++) {
          ViiewMarkupcarFareModel lm = ViiewMarkupcarFareModel.fromJson(list[i]);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<ViiewMarkupcarFareModel>?>(
