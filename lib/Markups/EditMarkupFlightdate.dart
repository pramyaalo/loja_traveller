...
class EditMarkupFlightdate extends StatefulWidget {
  final String ID;

  EditMarkupFlightdate({required this.ID});
  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<EditMarkupFlightdate> {
  ...
  Future<List<ViewmarkupFlightdateModel>?> getLabels() async {
    List<ViewmarkupFlightdateModel> labelData = [];

    Future<http.Response>? futureLabels = ResponseHandler.performPost(
      "MarkupFlightDateViewEdit",
      "Id=${widget.ID}",
    );
  ...
  Future<void> fetchAssetData() async {
    List<ViewmarkupFlightdateModel>? assets = await getLabels();
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  String apiUrl = "MarkupFlightDateSet";
                    ...
                    if (jsonResponse['Table'] != null &&
                      ...
                      if (totalPage != null && totalPage > 0) {
                        ...
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MarkupFlightDate(),
                          ),
                        );
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
