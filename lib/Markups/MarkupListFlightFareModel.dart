class MarkupListFlightFareModel {
  final String slNo;
  final String id;
  ...
  factory MarkupListFlightFareModel.fromJson(Map<String, dynamic> json) {
    return MarkupListFlightFareModel(
