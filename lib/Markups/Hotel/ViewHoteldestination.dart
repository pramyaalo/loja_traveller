...
class ViewHoteldestination extends StatefulWidget {
  final String Id;

  ViewHoteldestination({required this.Id});

  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<ViewHoteldestination> {
  Future<List<ViewMarkupHotelDestinationModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ViewMarkupHotelDestinationModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupHotelDestinationViewEdit", "Id=${widget.Id}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<ViewMarkupHotelDestinationModel>?>(
                                        ...
                                        Expanded(
                                          child: Align(
                                            alignment: AlignmentDirectional
                                                .centerStart,
                                            child: Text(
                                              snapshot.data![index].hotelCityName,
                                              style: const TextStyle(
                                                  fontFamily: "Montserrat",
                                                  fontWeight: FontWeight.w500),
                                            ),
