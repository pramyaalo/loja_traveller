class ViewMarkupHotelDateModel {
  final String id;
  ...
  factory ViewMarkupHotelDateModel.fromJson(Map<String, dynamic> json) {
    return ViewMarkupHotelDateModel(
      id: json['Id'].toString(),
