...
class ViewmarkupHotelrating extends StatefulWidget {
  final String Id;

  ViewmarkupHotelrating({required this.Id});

  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<ViewmarkupHotelrating> {
  Future<List<ViedwHotelratingModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ViedwHotelratingModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupHotelRatingViewEdit", "Id=${widget.Id}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<ViedwHotelratingModel>?>(
                                        ...
                                        Expanded(
                                          child: Align(
                                            alignment: AlignmentDirectional
                                                .centerStart,
                                            child: Text(
                                                snapshot.data![index].hotelRating+"Star",
                                              style: const TextStyle(
                                                  fontFamily: "Montserrat",
                                                  fontWeight: FontWeight.w500),
                                            ),
