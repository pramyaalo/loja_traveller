...
import 'ViewMarkupHotelDateModel.dart';

 


class ViewmarkupHotelDate extends StatefulWidget {
  final String Id;

  ViewmarkupHotelDate({required this.Id});

  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<ViewmarkupHotelDate> {
  Future<List<ViewMarkupHotelDateModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ViewMarkupHotelDateModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupHotelDateViewEdit", "Id=${widget.Id}");
    ...
    return await __futureLabels?.then((value) async {
      ...
      try {
        ...
        for (int i = 0; i < list.length; i++) {
          ViewMarkupHotelDateModel lm = ViewMarkupHotelDateModel.fromJson(list[i]);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<ViewMarkupHotelDateModel>?>(
