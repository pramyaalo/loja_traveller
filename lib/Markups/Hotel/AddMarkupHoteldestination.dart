...
class AddMarkupHoteldestination extends StatefulWidget {
  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<AddMarkupHoteldestination> {
                    ...
                    child: Autocomplete<DestinationnameModel>(
                      ...
                      onSelected: (DestinationnameModel? selectedOption) {
                        if (selectedOption != null) {
                          print('Selected: ${selectedOption.destinationName} (${selectedOption.countryCode})');
                          setState(() {
