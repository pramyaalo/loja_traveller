...
class ViewmarkupFlightAirline extends StatefulWidget {
  final String Id;

  ViewmarkupFlightAirline({required this.Id});

  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<ViewmarkupFlightAirline> {
  Future<List<ViewMarkupFlightAirlineModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ViewMarkupFlightAirlineModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupFlightAirlineViewEdit", "Id=${widget.Id}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<ViewMarkupFlightAirlineModel>?>(
                                        ...
                                        Expanded(
                                          child: Align(
                                            alignment: AlignmentDirectional
                                                .centerStart,
                                            child: Text(
                                              snapshot.data![index].airlineName,
                                              style: const TextStyle(
                                                  fontFamily: "Montserrat",
                                                  fontWeight: FontWeight.w500),
                                            ),
