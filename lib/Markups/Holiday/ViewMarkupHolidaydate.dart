...
class ViewMarkupHolidaydate extends StatefulWidget {
  final String Id;

  ViewMarkupHolidaydate({required this.Id});

  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<ViewMarkupHolidaydate> {
  Future<List<ViewMrkupHolidayDateModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ViewMrkupHolidayDateModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupHolidayDateViewEdit", "Id=${widget.Id}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<ViewMrkupHolidayDateModel>?>(
