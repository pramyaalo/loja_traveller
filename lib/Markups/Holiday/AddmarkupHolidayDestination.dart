...
class AddmarkupHolidayDestination extends StatefulWidget {
  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<AddmarkupHolidayDestination> {
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Autocomplete<DestinationNameModel>(
                      ...
                      '${option.latinFullName}, ${option.locationId}',
                      onSelected: (DestinationNameModel? selectedOption) {
                        if (selectedOption != null) {
                          print('Selected: ${selectedOption.latinFullName} (${selectedOption.locationId})');
                          setState(() {
