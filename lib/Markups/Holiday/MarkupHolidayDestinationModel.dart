class MarkupHolidayDestinationModel{
  final String id;
  ...
  factory MarkupHolidayDestinationModel.fromJson(Map<String, dynamic> json) {
    return MarkupHolidayDestinationModel(
      id: json['Id'].toString(),
