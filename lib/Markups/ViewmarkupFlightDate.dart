...
import 'ViewmarkupFlightdateModel.dart';


class ViewmarkupFlightDate extends StatefulWidget {
  final String Id;

  ViewmarkupFlightDate({required this.Id});

  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<ViewmarkupFlightDate> {
  Future<List<ViewmarkupFlightdateModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ViewmarkupFlightdateModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupFlightDateViewEdit", "Id=${widget.Id}");
    ...
    return await __futureLabels?.then((value) async {
      ...
      try {
        ...
        for (int i = 0; i < list.length; i++) {
          ViewmarkupFlightdateModel lm = ViewmarkupFlightdateModel.fromJson(list[i]);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<ViewmarkupFlightdateModel>?>(
