class MarkupListHotelRatingsModel {
  final String slNo;
  final String id;
  ...
  factory MarkupListHotelRatingsModel.fromJson(Map<String, dynamic> json) {
    return MarkupListHotelRatingsModel(
