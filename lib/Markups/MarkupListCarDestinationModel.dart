class MarkupListCarDestinationModel {
  final String slNo;
  final String id;
  ...
  factory MarkupListCarDestinationModel.fromJson(Map<String, dynamic> json) {
    return MarkupListCarDestinationModel(
