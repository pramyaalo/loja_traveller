...
class ViewMarkupFlightFare extends StatefulWidget {
  final String Id;

  ViewMarkupFlightFare({required this.Id});

  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<ViewMarkupFlightFare> {
  Future<List<ViewMarkupFlightFareModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ViewMarkupFlightFareModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupFlightFareViewEdit", "Id=${widget.Id}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<ViewMarkupFlightFareModel>?>(
