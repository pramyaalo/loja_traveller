class markupListHoteldateModel {
  final String slNo;
  final String id;
  ...
  factory markupListHoteldateModel.fromJson(Map<String, dynamic> json) {
    return markupListHoteldateModel(
