...
class ViewMarkupBusDate extends StatefulWidget {
  final String Id;

  ViewMarkupBusDate({required this.Id});

  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<ViewMarkupBusDate> {
  Future<List<ViewMarkupBusDateModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<ViewMarkupBusDateModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupBusDateViewEdit", "Id=${widget.Id}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<ViewMarkupBusDateModel>?>(
