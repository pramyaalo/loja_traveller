...
class AddmarkupBusDestination extends StatefulWidget {
  @override
  _MyRechargePageState createState() => _MyRechargePageState();
}

class _MyRechargePageState extends State<AddmarkupBusDestination> {
              ...
              child: ElevatedButton(
                onPressed: () async {
                  if (SelectionValue == null || SelectionValue.trim().isEmpty ||
                      Selectionvalue1 == null || Selectionvalue1.trim().isEmpty ||
                      FinalID == null || FinalID.trim().isEmpty ||
                      FinalID1 == null || FinalID1.trim().isEmpty ||
