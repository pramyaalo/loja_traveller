class MarkupListHolidayDateModel {
  final String slNo;
  final String id;
  ...
  factory MarkupListHolidayDateModel.fromJson(Map<String, dynamic> json) {
    return MarkupListHolidayDateModel(
