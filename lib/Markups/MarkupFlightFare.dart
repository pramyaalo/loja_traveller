...
import 'AddMarkupFlightFare.dart';
import 'EditMarkupFlightDestination.dart';
import 'EditMarkupFlightdate.dart';
import 'EditmarkupFlightFare.dart';
import 'MarkupFLightDestinationModel.dart';
import 'MarkupFareModel.dart';
import 'ViewMarkupFlightDestination.dart';
import 'ViewMarkupFlightFare.dart';


class MarkupFlightFare extends StatefulWidget {
  const MarkupFlightFare({Key? key}) : super(key: key);

  @override
  State<MarkupFlightFare> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<MarkupFlightFare> {
  ...
  Future<List<MarkupFareModel>?> getFlightTicketOrderQueue() async {
    String SubAgencyId = '';
    List<MarkupFareModel> bookingCardData = [];
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "MarkupFlightFareGet", "UserTypeId=$userTypeID&UserId=$userID&LoginUserTypeId=0&LoginUserId=0&Status=-1");
    ...
    return await __futureLabels?.then((value) async {
      ...
      try {
        ...
        for (int i = 0; i < list.length; i++) {
          MarkupFareModel lm = MarkupFareModel.fromJson(list[i]);
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => AddMarkupFlightFare()),
            );
          },
        ...
        body: Center(
          child: FutureBuilder<List<MarkupFareModel>?>(
                                                          ...
                                                          onTap: () {
                                                            Navigator.push(
                                                              ...
                                                              MaterialPageRoute(
                                                                builder:
                                                                    (context) =>
                                                                        ViewMarkupFlightFare(Id:snapshot.data![index].id
                                                          ...
                                                          onTap: () {
                                                            Navigator.push(
                                                              ...
                                                              MaterialPageRoute(
                                                                builder:
                                                                    (context) =>
                                                                        EditmarkupFlightFare(ID:snapshot.data![index].id),/*:snapshot.data![index].markupTypeId)*/
                                                              ),
                                                            );
                                                          },
                                                          child: Padding(
