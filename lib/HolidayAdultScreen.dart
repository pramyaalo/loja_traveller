...
class HolidayAdultScreen extends StatefulWidget {
  final flightDetails,
      resultFlightData,
      adultCount,
      childrenCount,
  ...
  @override
  State<HolidayAdultScreen> createState() => _OneWayBookingState();
}

class _OneWayBookingState extends State<HolidayAdultScreen> {
    ...
    try {
      ...
      if (widget.isEdit == 'Edit' && widget.adultIndex >= 0 && widget.adultIndex < mutableAdultsList.length) {
        ...
        if (adultId != null) {
          ...
          await dbHelper.updateholidayAdults(adultId, adultData);
        ...
        await dbHelper.insertholidayAdults(adultData);
        Fluttertoast.showToast(
