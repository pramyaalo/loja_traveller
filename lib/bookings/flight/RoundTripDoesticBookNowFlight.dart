...
class RoundTripDoesticBookNowFlight extends StatefulWidget {
  final flightDetails,
      resultFlightData,
      resultFlightData1,
      adultCount,
      ...
      infantCount,
      departdate;
  const RoundTripDoesticBookNowFlight({
    super.key,
    required this.flightDetails,
    required this.resultFlightData,
    required this.resultFlightData1,
  ...
  @override
  State<RoundTripDoesticBookNowFlight> createState() => _OneWayBookingState();
}

class _OneWayBookingState extends State<RoundTripDoesticBookNowFlight> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      resultFlightData1 = widget.resultFlightData1;
                            ...
                            itemBuilder: (BuildContext context, index) {
                              return Column(
                                children: [
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${CommonUtils.convertToFormattedTime(resultFlightData1[index + 1]['DepartureDate']).toString().toUpperCase()} ',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 18),
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${CommonUtils.convertToFormattedTime(resultFlightData1[index + 1]['ArrivalDate']).toString().toUpperCase()} ',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 18),
                                  ...
                                  index + 1 < (resultFlightData1.length - 1)
                                      ? Container(
                                          width: double.infinity,
                                          color: Color(0xfff7f7f7),
                                          margin: EdgeInsets.symmetric(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          resultFlightData1[0]['DepartureDate']
                                              .toString()
                                              .substring(0, 10),
                                        ),
                                        Text(
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          resultFlightData1[0]['ArrivalDate']
                                              .toString()
                                              .substring(0, 10),
                                        ),
                                        Text(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        Text(
                                          resultFlightData1[0]['CabinBaggage'],
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 13),
                                        ),
