...
import '../bookings/flight/oneway_booking.dart';
import '../bookings/hotels/HotelReviewBooking.dart';
...
class HotelCOnfirmationPage extends StatefulWidget {
  ...
  @override
  State<HotelCOnfirmationPage> createState() =>
      _BookingConfirmationPageState();
}

class _BookingConfirmationPageState extends State<HotelCOnfirmationPage> {
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "RecHotelInvoice", "BookId=${widget.bookingId}");
