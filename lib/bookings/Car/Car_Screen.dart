...
class _FlightsScreenState extends State<CarScreen> {
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: buildDropdown(
                                                    value: selectedTime,
                                                    items: timeList,   // ← MUST use timeList
                                                    onChanged: (value) {
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                _selectDate(context, 2);   // Always allow tap
                                              },
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    "${selectedReturnDate.toLocal()}".split(' ')[0],
                                                    style: TextStyle(
                                                      fontFamily: "Montserrat",
                                                      fontSize: 16,
                                                      fontWeight: FontWeight.bold,
