class Table1CreditNoteHotelreceiptModel {
  ...
  Table1CreditNoteHotelreceiptModel({
  ...
  factory Table1CreditNoteHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table1CreditNoteHotelreceiptModel(
