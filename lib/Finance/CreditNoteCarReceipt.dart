...
import 'Table8CreditNoteCarReceiptModel.dart';
...
class _BookingCardGeneralDetailsState extends State<CreditNoteCarReceipt> {
  ...
  List<Table8CreditNoteCarReceiptModel>tableData8=[];
                      ...
                      try {
                        ...
                        if (table8.isNotEmpty) {
                          for (int i = 0; i < table8.length; i++) {
                            Table8CreditNoteCarReceiptModel t6Data =
                            Table8CreditNoteCarReceiptModel.fromJson(
                                table8[i]);
                            tableData8.add(t6Data);
                            print(
                                'Index: $i, Table4 Length: ${table8.length}, t1Data: $t6Data');
                          }
                        }
                        //
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text('Base Fare: '+m4.currency+" "+m4.totalSales,
                                                  style: (TextStyle(
                                                      fontWeight: FontWeight.w500,
                                                      fontSize: 15))),
                                              Text(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                padding: EdgeInsets.only(
                                                    left: 10, top: 4),
                                                child: Text(
                                                  'Receipt No: ${tableData8[index].receiptNoTransId}',
                                                  style: TextStyle(
                                                      fontSize: 15,
                                                      fontWeight:
                                                      FontWeight.w500),
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                padding: EdgeInsets.only(
                                                    left: 10, top: 3),
                                                child: Text(
                                                  'Allocated Amount: ${tableData8[index].transactionAmount}',
                                                  style: TextStyle(
                                                      fontSize: 15,
                                                      fontWeight:
                                                      FontWeight.w500),
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                padding: EdgeInsets.only(
                                                    left: 10, top: 2),
                                                child: Text(
                                                  'Date: ${tableData8[index].transactionDate}',
                                                  style: TextStyle(
                                                      fontSize: 15,
                                                      fontWeight:
                                                      FontWeight.w500),
