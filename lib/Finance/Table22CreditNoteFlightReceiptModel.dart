class Table22CreditNoteFlightReceiptModel {
  ...
  Table22CreditNoteFlightReceiptModel({
  ...
  factory Table22CreditNoteFlightReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table22CreditNoteFlightReceiptModel(
