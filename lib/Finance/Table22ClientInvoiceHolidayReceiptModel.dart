class Table22ClientInvoiceHolidayReceiptModel {
  ...
  factory Table22ClientInvoiceHolidayReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table22ClientInvoiceHolidayReceiptModel(
