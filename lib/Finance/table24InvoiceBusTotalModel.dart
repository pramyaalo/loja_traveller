class table24InvoiceBusTotalModel {
  ...
  factory table24InvoiceBusTotalModel.fromJson(Map<String, dynamic> json) {
    return table24InvoiceBusTotalModel(
