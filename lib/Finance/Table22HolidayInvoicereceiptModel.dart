class Table22HolidayInvoicereceiptModel {
  ...
  Table22HolidayInvoicereceiptModel({
  ...
  factory Table22HolidayInvoicereceiptModel.fromJson(Map<String, dynamic> json) {
    return Table22HolidayInvoicereceiptModel(
