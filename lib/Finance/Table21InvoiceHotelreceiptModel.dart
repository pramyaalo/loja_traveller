class Table21InvoiceHotelreceiptModel {
  ...
  Table21InvoiceHotelreceiptModel({
  ...
  factory Table21InvoiceHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table21InvoiceHotelreceiptModel(
