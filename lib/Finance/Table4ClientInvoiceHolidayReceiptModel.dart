class Table4ClientInvoiceHolidayReceiptModel {
  ...
  Table4ClientInvoiceHolidayReceiptModel({
  ...
  factory Table4ClientInvoiceHolidayReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table4ClientInvoiceHolidayReceiptModel(
