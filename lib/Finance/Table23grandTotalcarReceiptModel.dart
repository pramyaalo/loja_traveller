class Table23grandTotalcarReceiptMode {
  ...
  Table23grandTotalcarReceiptMode({
  ...
  factory Table23grandTotalcarReceiptMode.fromJson(Map<String, dynamic> json) {
    return Table23grandTotalcarReceiptMode(
