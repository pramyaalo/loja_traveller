class Table23InvoiceHolidayReceipt {
  ...
  factory Table23InvoiceHolidayReceipt.fromJson(Map<String, dynamic> json) {
    return Table23InvoiceHolidayReceipt(
