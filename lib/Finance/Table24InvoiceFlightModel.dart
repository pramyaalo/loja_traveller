class Table24InvoiceFlightModel {
  final String name;
  ...
  factory Table24InvoiceFlightModel.fromJson(Map<String, dynamic> json) {
    return Table24InvoiceFlightModel(
