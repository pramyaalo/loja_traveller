class Table21VouchersHotelReceiptModel {
  ...
  Table21VouchersHotelReceiptModel({
  ...
  factory Table21VouchersHotelReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table21VouchersHotelReceiptModel(
