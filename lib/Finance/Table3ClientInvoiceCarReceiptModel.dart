class Table3ClientInvoiceCarReceiptModel {
  ...
  Table3ClientInvoiceCarReceiptModel({
  ...
  factory Table3ClientInvoiceCarReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table3ClientInvoiceCarReceiptModel(
