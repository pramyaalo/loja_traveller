class Table22CLientInvoiceHotelreceiptModel {
  ...
  Table22CLientInvoiceHotelreceiptModel({
  ...
  factory Table22CLientInvoiceHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table22CLientInvoiceHotelreceiptModel(
