class Table22HotelTermsandCondiitonModel {
  ...
  Table22HotelTermsandCondiitonModel({
  ...
  factory Table22HotelTermsandCondiitonModel.fromJson(Map<String, dynamic> json) {
    return Table22HotelTermsandCondiitonModel(
