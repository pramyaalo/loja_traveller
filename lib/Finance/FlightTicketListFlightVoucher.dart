...
import 'Table0FlightTicketVoucherModel.dart';
import 'Table1FlightTicketVoucherModel.dart';
import 'Table3FlightTicketVoucherModel.dart';
import 'Table4FlightTicketVoucherModel.dart';
import 'Table5FlightTicketVoucherModel.dart';
import 'Tablw23FlightPaymentInformationModel.dart';



class FlightTicketListFlightVoucher extends StatefulWidget {
  final String PassengerID, Id;

  FlightTicketListFlightVoucher({required this.PassengerID,required this.Id});
  @override
  State<FlightTicketListFlightVoucher> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<FlightTicketListFlightVoucher> {
  ...
  List<Table1FlightTicketVoucherModel> tableData1 = [];
  List<Table3FlightTicketVoucherModel>tableData3 = [];
  List<Table4FlightTicketVoucherModel>tableData4=[];
  List<Table5FlightTicketVoucherModel>tableData5=[];
  ...
  Future<String?> getLabels() async {
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "FlightTicketViewGet", "PassengerID=${widget.PassengerID}&BookId=${widget.Id}");
    print('jfghhjghId' + widget.Id);
    print('PassengerID' + widget.PassengerID);
          ...
          child: FutureBuilder<String?>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  try {
                    Table0FlightTicketVoucherModel m0 =
                    Table0FlightTicketVoucherModel.fromJson(table0[0]);
                    if (table0.isNotEmpty) {
                      m0 = Table0FlightTicketVoucherModel.fromJson(table0[0]);
                      print("fjhg" + m0.bookFlightId);
                    } else {
                      print('The list is empty.');
                    }
                    tableData1.clear();
                    Table1FlightTicketVoucherModel m1 =
                    Table1FlightTicketVoucherModel.fromJson(table1[0]);
                    if (table1.isNotEmpty) {
                      for (int i = 0; i < table1.length; i++) {
                        Table1FlightTicketVoucherModel t1Data =
                        Table1FlightTicketVoucherModel.fromJson(
                            table1[i]);
                    ...
                    tableData3.clear();
                    Table3FlightTicketVoucherModel m3 =
                    Table3FlightTicketVoucherModel.fromJson(table3[0]);
                    if (table3.isNotEmpty) {
                      for (int i = 0; i < table3.length; i++) {
                        Table3FlightTicketVoucherModel t6Data =
                        Table3FlightTicketVoucherModel.fromJson(
                            table3[i]);
                    ...
                    if (table4.isNotEmpty) {
                      Table4FlightTicketVoucherModel m4 =
                      Table4FlightTicketVoucherModel.fromJson(table4[0]);

                      for (int i = 0; i < table4.length; i++) {
                        Table4FlightTicketVoucherModel t6Data =
                        Table4FlightTicketVoucherModel.fromJson(table4[i]);
                        tableData4.add(t6Data);
                        print('Index: $i, Table4 Length: ${table4.length}, t6Data: $t6Data');
                      }
                    }


                    Table5FlightTicketVoucherModel? m5; // Declare it outside

                    tableData5.clear();

                    if (table5.isNotEmpty) {
                      m5 = Table5FlightTicketVoucherModel.fromJson(table5[0]);

                      for (int i = 0; i < table5.length; i++) {
                        Table5FlightTicketVoucherModel t6Data =
                        Table5FlightTicketVoucherModel.fromJson(table5[i]);
                        tableData5.add(t6Data);
                        print('Index: $i, Table5 Length: ${table5.length}, t6Data: $t6Data');
                      }
                    }
                            ...
                            Column(
                              children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  "${tableData1[index].passenger}",
                                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                              Text(
                                                'Type: ${tableData1[index].type}',
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Passenger ID: ${tableData1[index].passengerID}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                              Text(
                                                'Age : ${tableData1[index].age}',
                                                style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                              ),
                                            ],
                                          ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Phone : ${tableData1[index].tfpPhoneNo}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                              Expanded(
                                                child: Text(
                                                  'Ticket No : ${tableData1[index].pnr}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  overflow: TextOverflow.ellipsis,
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Depart Date: ${tableData3[index].tfsDepDatedt}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Arrival Date: ${tableData3[index].tfsArrDatedt}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  overflow: TextOverflow.ellipsis,
                                                  maxLines: 1,
                                                ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Depart: ${tableData3[index].tfsDepAirport}',
                                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                              ...
                                              Expanded(
                                                child: Text(
                                                  'Flight No: ${tableData3[index].tfsFlightNumber}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  textAlign: TextAlign.end,
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Arrival: ${tableData3[index].tfsArrAirport}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                              ...
                                              Expanded(
                                                child: Text(
                                                  'Duration: ${tableData3[index].tfsDuration}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  textAlign: TextAlign.end,
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Depart Date: ${tableData4[index].tfsDepDatedt}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Arrival Date: ${tableData4[index].tfsArrDatedt}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  overflow: TextOverflow.ellipsis,
                                                  maxLines: 1,
                                                ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Depart: ${tableData4[index].tfsDepAirport}',
                                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                              ...
                                              Expanded(
                                                child: Text(
                                                  'Flight No: ${tableData4[index].tfsFlightNumber}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  textAlign: TextAlign.end,
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Arrival: ${tableData4[index].tfsArrAirport}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ),
                                              ...
                                              Expanded(
                                                child: Text(
                                                  'Duration: ${tableData4[index].tfsDuration}',
                                                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                  textAlign: TextAlign.end,
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                ...
                                table5.isNotEmpty
                                  ...
                                  children: [
                                    _buildTableRow('Total Net Amount', m5?.currency??'', m5?.totalFare??'0'),
                                    _buildTableRow('Total GST ${m5?.gstPercent} %', m5?.currency??'', m5?.gstAmount??'0'),
                                    _buildTableRow('Service Charge and Tax', m5?.currency, m5?.gstAmount??'0'),
                                    _buildTableRow('Total Discount', m5?.currency??'', m5?.discountAmount??'0'),
                                    _buildTableRow('Total Price', m5?.currency??'', m5?.grandTotal??'0', isBold: true),
                                  ],
                                )
                                    : SizedBox(),
