class Table4FlightTicketVoucherModel {
  ...
  Table4FlightTicketVoucherModel({
  ...
  factory Table4FlightTicketVoucherModel.fromJson(Map<String, dynamic> json) {
    return Table4FlightTicketVoucherModel(
