...
import '../Booking/Table11BusInvoiceTotalModel.dart';
import '../Booking/Table13BusRemitanceModel.dart';

import '../Booking/Table1HotelModel.dart';
 import '../Booking/Table2BusDetailModel.dart';
import '../Booking/Table3BusDetailsModel.dart';
import '../Booking/Table3BusTravellerDetailModel.dart';
...
import 'Table23BusPamentInformationModel.dart';
...
class _BookingCardGeneralDetailsState extends State<VouchersBusReceipt> {
  ...
  List<Table3BusTravellerDetailModel>tableData3=[];
  List<Table4BusTravellerDetailModel>tableData4=[];
  List<Table5HotelPaymentDetailsModel>tableData5=[];
  List<Table23BusPamentInformationModel>tableData23=[];
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  try {
                    ...
                    tableData2.clear();
                    Table2BusDetailModel m2 =
                    Table2BusDetailModel.fromJson(table2[0]);
                    if (table2.isNotEmpty) {
                      for (int i = 0; i < table2.length; i++) {
                        Table2BusDetailModel t1Data =
                    ...
                    //tableData2
                    tableData3.clear();
                    Table3BusTravellerDetailModel m3 =
                    Table3BusTravellerDetailModel.fromJson(table3[0]);
                    if (table3.isNotEmpty) {
                      for (int i = 0; i < table3.length; i++) {
                        Table3BusTravellerDetailModel t1Data =
                        Table3BusTravellerDetailModel.fromJson(table3[i]);
                    ...
                    Table23BusPamentInformationModel? m23; // nullable, declared outside

                    tableData23.clear();
                    if (table23.isNotEmpty) {
                      m23 = Table23BusPamentInformationModel.fromJson(table23[0]);
                      for (int i = 0; i < table23.length; i++) {
                        Table23BusPamentInformationModel t1Data = Table23BusPamentInformationModel.fromJson(table23[i]);
...
// Now you can safely check and use m23
                    if (m23 != null) {
                      print('Total Fare: ${m23.totalFare}');
                    } else {
                      print('No data found for totalFare');
                    }


                    if (table6.isNotEmpty) {
                      Table6HotemModel m6 = Table6HotemModel.fromJson(table6[0]);
                      // Use m6 here as needed
                    } else {
                    ...
                    if (table13.isNotEmpty) {
                      Table13BusRemitanceModel m12 = Table13BusRemitanceModel.fromJson(table13[0]);
                      for (int i = 0; i < table13.length; i++) {
                        Table13BusRemitanceModel t6Data = Table13BusRemitanceModel.fromJson(table13[i]);
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                      'DropOff Location: ${tableData2[index].destinationCityLocation}',
                                                      style: (TextStyle(
                                                          fontWeight:
                                                          FontWeight.w500,
                                                          fontSize: 15))),
