class Table23VouchercarReceiptModel {
  ...
  factory Table23VouchercarReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table23VouchercarReceiptModel(
