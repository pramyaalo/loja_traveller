class Table4VoucherHolidayReceiptModel {
  ...
  Table4VoucherHolidayReceiptModel({
  ...
  factory Table4VoucherHolidayReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table4VoucherHolidayReceiptModel(
