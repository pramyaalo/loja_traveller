class Table23VoucherHolidayPaymentInformationModel {
  ...
  Table23VoucherHolidayPaymentInformationModel({
  ...
  factory Table23VoucherHolidayPaymentInformationModel.fromJson(Map<String, dynamic> json) {
    return Table23VoucherHolidayPaymentInformationModel(
