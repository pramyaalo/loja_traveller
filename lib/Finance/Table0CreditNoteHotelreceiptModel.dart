class Table0CreditNoteHotelreceiptModel {
  String bookFlightId;
  String bookingId;
  ...
  Table0CreditNoteHotelreceiptModel({
  ...
  factory Table0CreditNoteHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table0CreditNoteHotelreceiptModel(
