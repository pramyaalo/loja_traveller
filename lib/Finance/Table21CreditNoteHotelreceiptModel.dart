class Table21CreditNoteHotelreceiptModel {
  ...
  Table21CreditNoteHotelreceiptModel({
  ...
  factory Table21CreditNoteHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table21CreditNoteHotelreceiptModel(
