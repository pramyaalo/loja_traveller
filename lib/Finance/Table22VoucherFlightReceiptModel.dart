class Table22VoucherFlightReceiptModel {
  ...
  Table22VoucherFlightReceiptModel({
  ...
  factory Table22VoucherFlightReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table22VoucherFlightReceiptModel(
