class Table22VouchercarReceiptModel {
  ...
  factory Table22VouchercarReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table22VouchercarReceiptModel(
