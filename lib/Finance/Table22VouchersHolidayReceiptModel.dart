class Table22VouchersHolidayReceiptModel {
  ...
  Table22VouchersHolidayReceiptModel({
  ...
  factory Table22VouchersHolidayReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table22VouchersHolidayReceiptModel(
