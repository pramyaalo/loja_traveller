class Table4InvoiceHotelreceiptModel {
  ...
  Table4InvoiceHotelreceiptModel({
  ...
  factory Table4InvoiceHotelreceiptModel.fromJson(Map<String, dynamic> json) {
    return Table4InvoiceHotelreceiptModel(
