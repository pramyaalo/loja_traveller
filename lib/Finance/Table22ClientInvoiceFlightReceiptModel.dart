class Table22ClientInvoiceFlightReceiptModel {
  ...
  Table22ClientInvoiceFlightReceiptModel({
  ...
  factory Table22ClientInvoiceFlightReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table22ClientInvoiceFlightReceiptModel(
