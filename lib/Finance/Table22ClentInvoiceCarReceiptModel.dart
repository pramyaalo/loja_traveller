class Table22ClentInvoiceCarReceiptModel {
  ...
  Table22ClentInvoiceCarReceiptModel({
  ...
  factory Table22ClentInvoiceCarReceiptModel.fromJson(Map<String, dynamic> json) {
    return Table22ClentInvoiceCarReceiptModel(
