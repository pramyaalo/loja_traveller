...
import 'package:loja_traveller/Finance/table24InvoiceBusTotalModel.dart';

import 'dart:developer' as developer;

import '../Booking/Table2BusDetailModel.dart';
import '../Booking/Table3ClientInvoiceBusReceiptModel.dart';
import '../Booking/Table4CarPaymentInformationModel.dart';
import '../Booking/Table7ClientInvoiceBusReceiptModel.dart';
...
class InvoiceBusReceipt extends StatefulWidget {
  final String Id;

  InvoiceBusReceipt({required this.Id});
  @override
  State<InvoiceBusReceipt> createState() => _BookingCardGeneralDetailsState();
}

class _BookingCardGeneralDetailsState extends State<InvoiceBusReceipt> {
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.connectionState == ConnectionState.done) {
                      try {
                        ...
                        table24InvoiceBusTotalModel? m24;

                        if (table24.isNotEmpty) {
                          m24 = table24InvoiceBusTotalModel.fromJson(table24[0]);
