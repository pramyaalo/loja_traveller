...
class _BookingReportState extends State<BookingReport> {
  ...
  static Future<List<BookingReportModel>?> getLabels() async {
    ...
    Future<http.Response>? __futureLabels = ResponseHandler.performPost(
        "BookingReportGet",
        "UserId=$userID&UserTypeId=$userTypeID&FromDate=&ToDate=&StaffId=");
    print('jfghhjgh');
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: Text(
                                                              snapshot.data![index].bookingStatus.toString().isEmpty
                                                                  ? 'No Status'
                                                                  : snapshot.data![index].bookingStatus.toString(),
                                                              style: TextStyle(
                                                                fontFamily:
                                                                "Montserrat",
                                                                fontSize: 15,
